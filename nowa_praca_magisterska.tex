...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.6]{obrazy_teoria/kaskada_hadron_foton.pdf}
...
Teleskop LST używa systemy odczytu sygnały nazywanego Dragon
, który został stworzony w Institude of Cosmic Ray Research Uniwersytetu Tokijskiego. System oparty jest na chipie DRS4, który wymaga szeregu korekcji programowalnych w celu optymalnej pracy. Zaletą chipu DRS4 jest duża szybkość próbkowania, dzięki której możliwe jest lepsza redukcja szumów od fotonów tła nocnego nieba (ang. \textsl{night sky background}, NSB).
%Teleskop LST  ma lustro o średnicy 23 metrów, a kamera LST składa się z 1855 fotopowielaczy (PMT). 
Ze względu na dużą powierzchnie lustra, fotony NSB są rejestrowane z częstotliwością kilkuset MHz na piksel. W celu redukcji zanieczyszczenia sygnału przez NSB oraz poprawy stosunku sygnału do szumu, konieczne jest próbkowanie  sygnału z szybkością $\sim$ 1 GHz i zmniejszenie czasu całkowania sygnału do kilku ns \cite{dragon_lst}.
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.4]{wykresy/drs4/dt_corr_hist2d_0.pdf}
...
\hline
korekcja & średnia HG  & std HG  & średnia LG & std LG & $> 2 \sigma$ [\%] HG & $> 2 \sigma$ [\%] LG \\ \hline
bez  & 259.7  & 44.6  & 212.4 & 44.26    \\ \hline
linii bazowa & 300.8  & 8.8  & 300.8 & 7.6 & 2.7 & 2.3    \\  \hline
czasowa linii bazowej & 297.3  & 6.5  & 297.3 & 4.61 & 0.16 & 0.13  \\  \hline
interpolacja SNG & 297.0  & 6. 3 &  297.1 & 4.36 & 0.05 & 0.02  \\  \hline
\end{tabular}
\label{tab:std}
\end{table}
...
\end{figure}
Na rysunku \ref{fig:waveform_27_lg} pokazuje analogiczny przebieg sygnału, tylko dla niskiego wzmocnienia (LG). Jak widzimy w tych przebiegach szum sygnału jest dużo mniejszy, ale także sygnał jest bardzo słaby i dzięki zastosowaniu korekcji możliwe jest uzyskanie użytecznego sygnału.
\begin{figure}[H] 
\centering
...
\end{figure}
\newpage
Na rysunku \ref{fig:map_time_27} pokazuje mapę czasu przyjścia sygnału przed i po zastosowaniu korekcji względnej. Przedstawiony obraz jest po wyczyszczeniu obrazu za pomocą funkcji {\bf{tailcuts\_clean}} z biblioteki {\bf{ctapipe}}. Na obrazie po dokonaniu korekcji czasowej widzimy wyraźny gradient czasu przyjścia.
\begin{figure}[H] 
\centering
\includegraphics[scale=0.5]{wykresy/drs4/time_corr_image_id_27_clean.png}
\caption{Mapa czasu przyjścia sygnału przed i po korekjci czasowej.}
\label{fig:map_time_27}
\end{figure}
\subsection{Drugi obraz}
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/shower_id_77.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{wykresy/drs4/waveform_HG_id_77.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{wykresy/drs4/waveform_LG_id_77.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.5]{wykresy/drs4/time_corr_image_77.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{wykresy/drs4/waveform_HG_id_184.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{wykresy/drs4/waveform_LG_id_184.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.5]{wykresy/drs4/time_corr_image_184.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
\newpage
