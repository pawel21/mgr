...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/baseline_corr_hist.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.4]{wykresy/drs4/dt_curve_fit_diff.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{wykresy/drs4/dt_curve_fit_diff_hist.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{wykresy/drs4/spike_teoria.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.25]{wykresy/drs4/spike_corr_hist.pdf}
