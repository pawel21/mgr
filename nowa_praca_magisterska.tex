...
\caption{Histogram pokrycia kondensatorów oraz czasu przyjścia zdarzeń. Run 00097, wszystkie piksele.}
\label{fig:data_hist}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.22]{wykresy/drs4/fourier_fit_3pixels.pdf}
\caption{Piksel 180. 32 harmoniczne}
\label{fig:fourier_fit}
\end{figure}
