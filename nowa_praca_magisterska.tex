...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.4]{wykresy/drs4/ped_hg.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.4]{wykresy/drs4/baseline_corr.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.4]{wykresy/drs4/baseline_corr_hist.pdf}
...
\label{mc_pek}
  \begin{center}
  \subfloat[Przed kalibracją linii bazowej.]{\includegraphics[scale=0.25]{wykresy/drs4/map_cam_hg_raw.pdf}\label{fig:f1}}
  \hfill
  \subfloat[Po kalibracji linii bazowej.]{\includegraphics[scale=0.25]{wykresy/drs4/map_cam_hg_baseline_corr.pdf}\label{fig:f2}}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.45]{wykresy/drs4/dt_corr_teoria.pdf}
\caption{Przykładowe przebiegi sygnału w których wystąpił skok sygnału spowodowany krótkim czasem odczytu danego kondensatora.}
\label{fig:dt_corr_Waveform}
\end{figure}
\subsubsection{Funkcja potęgowa do kalibracji}
Jak było napisane w poprzednim rozdziale do kalibracji wykorzystuje się funkcje potęgową \ref{eqn:power_law}, której współczynniki zależą od temperatury. Z testów w Japonii zdane są współczynniki przy temperaturach: 10, 20, 30, 40 i 50 $^\circ$C. W ramach swojej pracy sprawdziłem, które współczynniki należy użyć dla systemu odczytu działającego w teleskopie LST. 
\begin{figure}[H] 
\centering
\includegraphics[scale=0.37]{wykresy/drs4/dt_curve_fit.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:baseline_corr_hist}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.33]{wykresy/drs4/dt_curve_at_point_hist.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:baseline_corr_hist}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/dt_hist2d.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:baseline_corr_hist}
\end{figure}
