...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/dt_corr_hist2d.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/dt_corr_lg_hist2d.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{wykresy/drs4/mapka_sygnal_time_corr.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/fourier_fit_harm.pdf}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/std_arrival_time_hist.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.35]{wykresy/drs4/std_arrival_time_map.pdf}
\caption{Korekcja linii bazowej histogram, wszystkie piksele.}
\label{fig:muon_image}
\end{figure}
\newpage
